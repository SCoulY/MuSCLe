...
if __name__ == '__main__':
    ...
    parser.add_argument("--list", default='/home/lunet/coky/CAM/VOC2012/ImageSets/Segmentation/train.txt', type=str)
    parser.add_argument("--predict_dir", default='/home/lunet/coky/CAM/0116_infer_Effseg_sgc', type=str)
    parser.add_argument("--gt_dir", default='/home/lunet/coky/CAM/VOC2012/SegmentationClass', type=str)
    parser.add_argument('--logfile', default='./evallog_0116_effseg.txt',type=str)
    ...
    if not args.curve:
        ...
        l = []
        for i in range(60):
            t = i/100.0 # background threshold
